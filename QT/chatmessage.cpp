...
{
    ui->setupUi(this);
    connect(ui->pushButton,SIGNAL(clicked()),this,SLOT(sendclicked()));
...
void ChatMessage::dealMessage(QNChatMessage *messageW, QListWidgetItem *item, QString text, QString time,  QNChatMessage::User_Type type)
{
...
void ChatMessage::dealMessageTime(QString curMsgTime)
{
